...
\usepackage{babel} % Tout ce qu'il faut pour supporter un texte écrit en français
...
\usepackage[autostyle=true, french=guillemets]{csquotes} % Pour respecter la typographie française des guillemets, surtout dans les références
...
\addtolength{\headheight}{4.758pt} % Increase the spacing around the header slightly
\renewcommand{\footrulewidth}{0pt} % Removes the rule in the footer
\fancypagestyle{plain}{\fancyhead{}\renewcommand{\headrulewidth}{0pt}} % Style for when a plain pagestyle is specified
%\fancyfoot[L]{\sffamily\normalsize La perception du temps} % pied de page (moche)
%\fancyfoot[R]{\sffamily\normalsize Lucas Shooner}
...
% Bibliography
\usepackage[sorting=nyt,sortcites=true,autopunct=true,autolang=hyphen,hyperref=true,abbreviate=false,backref=true,backend=biber]{biblatex} %
\DefineBibliographyStrings{french}{andothers={et coll\adddot}}
\addbibresource{bibliographie.bib} % BibTeX bibliography file
