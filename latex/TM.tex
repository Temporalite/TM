...
\begin{table}[h]
	\centering
	\caption{Expérience ennuyante (5 min 20 s} \label{tbl:exp1.1}
	\begin{tabular}{lc}
		\toprule 
...
\begin{table}[h]
	\centering
	\caption{Expérience intéressante (5 min 30 s)} \label{tbl:exp1.1}
	\begin{tabular}{lc}
		\toprule
...
\begin{table}[h]
	...
	\begin{tabular}{llll}
		\toprule 
		\textbf{Nom} & \textbf{Temps moyen 1} & \textbf{Temps moyen 2} & \textbf{$\Delta$ temps moyen} \\ \midrule
		Aurélien & 9,69 & 11,33 & 1,64 \\
		Célia & 10,42 & 10,65 & 0,23 \\
		Damien & 7,69 & 8,69 & 1,00 \\
		Léana & 9,50 & 8,90 & -0,61 \\
		Louis & 10,91 & 17,36 & 6,44 \\
		Nils & 10,54 & 10,28 & -0,26 \\ \bottomrule
	\end{tabular}
\end{table}
