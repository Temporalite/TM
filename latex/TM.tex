...
\begin{figure}[h] \centering{
	...
	\caption{Répartition des résultats de l'expérience A selon la loi normale centrée et réduite. L'aire des bulle est proportionnelle au nombre de résultats identiques.}
\end{figure}

\begin{figure}[h] \centering{
		\includegraphics[width=\textwidth]{loiNormB.pdf}}
	\caption{Répartition des résultats de l'expérience B selon la loi normale centrée et réduite. L'aire des bulle est proportionnelle au nombre de résultats identiques.}
\end{figure}
