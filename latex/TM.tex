...
\begin{figure}[h]
	\centering{
		\input{img/pacemaker.pdf_tex}
		\caption{Modèle de traitement de l'information temporelle \cite{imgPouthas}}
		\label{fig:aires}
	}
\end{figure}

La situation de ce « pacemaker » n'est cependant pas clairement établie et bien que de nombreux auteurs\footnote{citer plein d'auteurs} le placent  la situe dans les ganglions de la base
