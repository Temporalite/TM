...
\begin{table}[h]
	\centering
	\caption{Compte des réponses} \label{tbl:analyse1.2}
	\begin{tabular}{lrr}
		\toprule
		\textbf{La vidéo est jugée} & \textbf{A} & \textbf{B} \\ \midrule
		Totalement ennuyeuse & 9 & - \\ 
		Ennuyeuse & 6 & 2 \\
		Ni ennuyeuse ni intéressante & - & 3 \\
		Intéressante & - & 7 \\ 
		Totalement intéressante & - & 3 \\ \bottomrule
	\end{tabular}
\end{table}
...
\begin{table}[h]
	...
	\begin{tabular}{lrr}
		...
		Totalement ennuyeuse (1 point) & 9 & - \\ 
		Ennuyeuse (2 points) & 12 & 4 \\
		Ni ennuyeuse ni intéressante (3 points) & - & 9 \\
		Intéressante (4 points) & - & 28 \\ 
		Totalement intéressante (5 points) & - & 15 \\ \cmidrule{2-3}
		Total (max. 75 points) & 21 & 56 \\ \bottomrule
	\end{tabular}
\end{table}

Les réponses données lors de ce test ne servent pas à indiquer des intervalles d'appréciation, la différence d'intérêt entre deux réponses n'étant pas identique, c'est pourquoi il est préférable de l'analyser en se concentrant sur les modalités ayant remporté le plus de points. La vidéo A
