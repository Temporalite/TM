...
L'hypothèse mise à l'épreuve est toujours de définir si une activité physique (qui échauffe mais n'épuise pas) modifie la façon dont nous appréhendons le temps.

\subsection{Redéfinition du protocole} \label{ssec:defProto2.2}
\begin{remark}
	Le protocole est presque identique à celui de la préparation (cf. page \pageref{sssec:preparation2.1}). Pour éviter une redondance innutile, seuls les points modifiés sont mentionnés.
\end{remark}
...
\begin{table}[h]
	\centering
	\caption{Résultats de l'expérience 2 (les résultats entre parenthèse sont )} \label{tbl:exp2.2}
	\begin{tabular}{lrlrlr}
		\toprule
		\textbf{Nom} &  \multicolumn{2}{c}{\textbf{Tmoyen 1 [s]}}  & \multicolumn{2}{c}{\textbf{Tmoyen 2 [s]}} & \textbf{$\Delta$ Tmoyen [s]} \\ \midrule
		...
		Louis 2 & 11,19 & (10,50 \& 11,89) & 10,72 & (12,09 \& 9,36) & -0,47 \\
...
\begin{table}[h!]
	...
	\begin{tabular}{lrr}
		...
		Différence médiane & 0,18 & 0,13 \\
		Différence moyenne & 0,76 & 0,33 \\
