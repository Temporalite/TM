...
\subsection[La temporalité]{La temporalité \cite{reptemps,basePerception}} \label{ssec:temporalite} % définition générale de comment ça marche, des moyens pour étudier la temporalité, puis ceux que je pourrais/vais employer
	stimulus pour tous les autres sens mais pas pour la perception du temps --> il n'est perçu par aucun de nos 5 sens. -> c'est quoi le temps ? Pourquoi Passe-il plus ou moins vite ? Importance de l'expérience que l'on vit du temps. ms -> années. Temps social comme le calendrier = pas de structures cerebrales dédiés, pas 
