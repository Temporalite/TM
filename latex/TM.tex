...
Il est demandé à cet effet à des volontaires de se relaxer puis de faire de la corde à sauter. Après chacune de ces activités, ils doivent produire une durée qu'ils pensent être égale à celle demandée, l'objectif étant de déterminer si une activité physique modifie la perception temporelle par la comparaison des deux durées.
...
\begin{description}
 ...
 \item[Une salle] item
 \item[Une corde à sauter] item
 \item[Un chronomètre dont le compteur n'est pas visible] item
