...
\chapter{\'Etude expérimentale} \label{chap:etudeExp}
...
\begin{table}[h]
	\centering
	\caption{Expérience ennuyante (5 min 20 s)} \label{tab:expA}
	\begin{tabular}{@{}lc@{}}
		\toprule 
...
\begin{table}[h]
	\centering
	\caption{Expérience intéressante (5 min 30 s)} \label{tab:expB}
	\begin{tabular}{@{}lc@{}}
		\toprule
		\multicolumn{1}{@{}c@{}}{Nom} & Temps perçu {[}min{}] \\ \midrule
		\qquad Anonyme 3 & 2,5 \\
...
\begin{table}[h!]
	\centering
	\caption{Analyse des résultats} \label{tab:analyse}
	\begin{tabular}{@{}lcc@{}}
		\toprule
