...
Cette expérience a été pensée pour être effectuée de la manière la plus simple qui soit et j'ai essayé de faire en sorte qu'elle ne dépende pas de plusieurs facteurs pour produire des résultats. Cela s'est révélé bénéfique puisqu'il n'y a que peu de biais auxquels je pense. Cela ne signifie évidemment pas qu'elle en est dépourvue mais l'expérience préparatoire m'a aidé dans le déroulement de sa grande soeur. Grâce à cela, j'ai pu éviter de 
