...
Commençons par considérer les valeurs extrêmes récoltées lors de l'expérience. Bien qu'elle ne soient que peu utiles pour déterminer si l'on peut rejeter l'hypothèse nulle (à savoir : l'expérience n'a aucun effet sur la perception temporelle des participants), elle sont utiles pour déterminer l'état d'esprit des participants. Elles nous renseignent en effet sur les divergences les plus fortes et indiquent 
...
% 		\caption{Histogramme représentant la répartition des participants en fonction du temps perçu lors de la partie A. }
% \end{minipage}
% \hfill
% \begin{minipage}[t]{.49\textwidth}
% 	 \centering{
% 			\includegraphics[trim=53 10 115 30, clip, width=\textwidth]{histB.png}}
