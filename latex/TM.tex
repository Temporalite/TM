...
Si l'on considère l'ensemble de ces facteurs, il en ressort que cette expérience est complexe car elle repose sur une variable psychologique, de nature aléatoire et fortement influençable par un grand nombre de biais dont la plupart sont issus de la complexité du protocole. L'analyse des résultats s'accompagne ainsi d'une grande incertitude à cause du petit nombre de participants.
...
Commençons par considérer les valeur extrêmes
...
\begin{minipage}[t]{.49\textwidth}
	 \centering{
			\includegraphics[trim=50 10 197 30, clip, width=\textwidth]{histA.png}} % gauche bas droite haut
		\caption{Histogramme représentant la répartition des participants en fonction du temps perçu lors de la partie A. }
\end{minipage}
\hfill
\begin{minipage}[t]{.49\textwidth}
	 \centering{
			\includegraphics[trim=122 10 125 30, clip, width=\textwidth]{histB.png}}
...
\begin{minipage}[t]{.49\textwidth}
	 \centering{
			\includegraphics[trim=133.5 10 130 26.5, clip, width=\textwidth]{loiNormA.png}}
