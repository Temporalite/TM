...
\section*{Résumé}
Le temps est un paramètre très important de nos vies. Bien que l'on puisse momentanément de ne pas y faire attention, il nous est impossible de nous soustraire du sentiment de son écoulement. Nous l'éprouvons au même titre que nos autres sens mais il n'est provoqué par aucun stimulus perceptible physiquement, nous ne possédons pas non plus de récépteurs temporels alors comment sommes-nous capables de le percevoir ?
...
Le temps est influencé par par les phases de la vie \cite{quesaije}
...
Références non présentes dans le texte mais qu'il faudra bien placer un jour : \cite{vidnul} \cite{vidcool}  \cite{analysedonnees}
