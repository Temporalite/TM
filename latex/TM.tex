...
\begin{figure}[h]
	\centering{
		...
		\caption{Modèle de traitement de l'information temporelle \cite{imgPouthas}}
		\label{fig:aires}
	}
\end{figure}
...
Le temps subjectif est donc en moyenne identique au temps réel, L'écart entre les estimations et l'estimation moyenne croit linéairement et le coefficient de variation du temps produit est linéaire, quelle que soit la durée à estimer. La plus petite différence de temps à pouvoir être perçue augmente aussi de façon linéaire, selon une forme de la loi de Weber\footnote{John H. Wearden et Bairbre McShane (1988)} (elle décrit la relation entretenue par la sensation avec la grandeur physique d'un stimulus. La plus petite différence d'intensité perçue est identique lorsque l'on essaie de distinguer deux objets pesant 1 et 1,1 kg de deux autres de 10 et 11kg [CITER WIKI CAR C/C !]) C'est pour cela que nous comptons lorsque nous devons estimer une durée de manière précise. Le fait d'incrémenter un compte d'une unité pour chaque seconde nous permet de nous concentrer sur une petite durée temporelle et minimise l'e  


 et 


Il esxiste deux théories pour situer cette zone responsable de la perception du temps, 
